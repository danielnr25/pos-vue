...
<template>
    ...
    >
        ...
        <div class="space-y-2 flex-auto">
            <h3 class="text-gray-900 font-bold">{{ product.name }}</h3>
            <p class="font-semibold text-blue-900">{{ formatCurrency( product.price) }} </p>
            <p class="text-green-600 font-medium">{{ product.availability }} en stock </p>
        </div>
